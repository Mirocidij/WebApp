...
import { FirstCodeExample } from "./Lessons/FirstLesson/FirstCodeExample";
...
const Home = () => (
  <div>
    ...
    <ul>
      ...
      <li><strong>Efficient production builds</strong>. In production mode, development-time features are disabled, and
